...
class PHPMailer
{
    ...
    function AddAddress($address, $name = "") {
		if($this->checkEmail($address)){
			$name = ereg_replace("[^[:space:]a-zA-Z0-9*_.-]", "", $name); // strip anything weird out of name
        	$cur = count($this->to);
    ...
    */
    ...
    function CreateHeader() {
		...
		if($this->checkEmail($this->From)){
			...
			$this->FromName = ereg_replace("[^[:space:]a-zA-Z0-9*_.-]", "", $this->FromName); // strip anything weird out of name
       		$from[0][1] = $this->FromName;
		}else{
			$this->SetError("Invalid E-Mail('$this->From')");
		}
