...
<script language="javascript" src="<?= $site_baseurl; ?>inc/photogallery.js"></script>
<?= $meta_content; ?>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><div id="container">
      ...
      <!-- End #Nav -->
      <div id="content">
        <div id="subheader"><img src="<?= $site_baseurl; ?>images/logo.png" alt="Playas Escondidas" name="logo" id="logo" /><img src="<?= $site_baseurl; ?>images/subheader-gallery.jpg" alt="rotating images" /></div>
        <div id="contentMap">
          <p>
            <?
...
if (is_numeric($gallery_id)) { # display galleries
	...
	if (mysql_num_rows($rs) > 0) {
		...
		if (is_numeric($gallery_thumbnail_rows))
			$thumbnails = "<div align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"".$thumbnailstyle."\"><tr valign=\"top\">\n";
...
if ($category_links <> "")
	echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
	 <tr valign=\"top\"><td width=\"20%\">".$category_links."</td><td width=\"95%\">";
#if ($num_galleries > 1)
