...
<script type="text/javascript" src="inc/announcements.js"></script>
</head>
...
<div id="content">
  ...
  <? } ?>
  <p>&nbsp;</p>
			  <div id="4what_announcement_text">
			
			  </div>
			  <script language="javascript">
			  	get_announcement("http://www.4whatbsg.com/labs/toolbox/edit/announcement.txt");
			  </script>
